...
**  void	*mlx_new_image2(void *mlx,int width,int height);
*/
...
int	mlx_put_image_to_window(void *mlx, void *win_ptr, void *img_ptr,
				int x, int y);
int	mlx_get_color_value(void *mlx, int color);
...
int	mlx_string_put(void *mlx, void *win_ptr, int x, int y, int color,
		       char *string);
void	mlx_set_font(void *mlx, void *win_ptr, char *name);
void	*mlx_xpm_to_image(void *mlx, char **xpm_data,
...
int	mlx_mouse_show(void *mlx, void *win_ptr);
